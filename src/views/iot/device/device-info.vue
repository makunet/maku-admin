      ...
      <el-row :gutter="30">
        <el-col :span="12">
          <el-form-item label="设备状态">
            <ma-dict-select v-model="dataForm.status" dict-type="enable_disable" disabled
                            style="width: 100%"></ma-dict-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="运行状态">
            <ma-dict-select v-model="dataForm.runningStatus" dict-type="device_running_status" disabled
                            style="width: 100%"></ma-dict-select>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="设备类型">
            <ma-dict-select v-model="dataForm.type" dict-type="device_type" disabled
                            style="width: 100%"></ma-dict-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
import { useIot_deviceApi } from "@/api/iot/device";
