<template>
  ...
  <el-card>
    <el-space>
      <el-space>
        <el-button v-auth="'iot:device:save'" icon="Plus" type="primary" @click="addOrUpdateHandle()">新增
        </el-button>
      </el-space>
      <el-space>
        <el-button v-auth="'iot:device:delete'" icon="Delete" plain type="danger" @click="deleteBatchHandle()">
          批量删除
        </el-button>
      </el-space>
    </el-space>
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table"
      ...
      <el-table-column prop="batteryPercent" label="电池电量" header-align="center"
      ...
      <el-table-column label="操作" fixed="right" header-align="center" align="center" width="200">
        <template #default="scope">
          <el-button v-auth="'iot:device:info'" type="primary" link @click="showDeviceDetailsHandle(scope.row)">
            设备详情
          </el-button>
          <el-button v-auth="'iot:device:delete'" type="primary" link @click="deleteBatchHandle(scope.row.id)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-drawer v-if="deviceDetailsVisible" v-model="deviceDetailsVisible" :title="deviceDetailsTitle" :size="800"
...
<script setup lang="ts" name="IotIot_deviceIndex">
